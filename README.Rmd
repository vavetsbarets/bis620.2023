...
To access the vignette, click the link (in the about section on the right side) to the webpage. On the webpage open BIS620-final-project article which the vignette for the final project
